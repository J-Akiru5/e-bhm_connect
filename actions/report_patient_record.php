<?php
// actions/report_patient_record.php
// Generate a PDF report for a single patient using FPDF
...
try {
    ...
    error_log('Report patient fetch error: ' . $e->getMessage());
...
$filename = 'Patient_Record_' . $patient_id . '.pdf';
