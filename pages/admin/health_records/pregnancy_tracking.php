                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    ...
                                    <form method="POST" action="<?php echo BASE_URL; ?>?action=delete-pregnancy-tracking" class="d-inline delete-form">
                                        <?php echo csrf_input(); ?>
                                        <input type="hidden" name="id" value="<?php echo $rec['pregnancy_id']; ?>">
